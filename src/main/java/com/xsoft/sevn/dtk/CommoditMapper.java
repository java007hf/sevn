...
//            "is_chaoshi, is_choice, is_tmall, main_pic, original_price, price, shop_name, commission, dtkCommoditURL, " +
...
//            "#{price}, #{shop_name}, #{commission}, #{dtkCommoditURL}, #{shortLink}, #{redirectsURL}, " +
